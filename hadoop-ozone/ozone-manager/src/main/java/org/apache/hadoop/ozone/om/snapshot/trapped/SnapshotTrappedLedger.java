...
/**
 * Trapped accounting deleted-entry ledger with a bounded read-through cache.
 */
public class SnapshotTrappedLedger {
  ...
  public boolean putIfAbsent(
    ...
    Preconditions.checkNotNull(deleteDbKey, "deleteDbKey == null");

    String ledgerKey =
        SnapshotTrappedLedgerEntry.encodeKey(volumeId, bucketId, deleteDbKey);
