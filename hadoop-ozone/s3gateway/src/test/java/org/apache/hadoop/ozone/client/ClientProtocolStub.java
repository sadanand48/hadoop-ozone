...
public class ClientProtocolStub implements ClientProtocol {
   ...
   */
  @Override public OzoneDataStreamOutput createStreamKey(String volumeName,
   ...
   * @throws IOException
   */
  @Override public OzoneDataStreamOutput createMultipartStreamKey(
      String volumeName, String bucketName, String keyName, long size,
      int partNumber, String uploadID) throws IOException {
    return null;
  }

  @Override public OzoneDataStreamOutput createStreamFile(String volumeName,
      String bucketName, String keyName, long size,
